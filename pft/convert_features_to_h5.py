...
print('oi1')
listImage = pd.read_pickle('./all_images_256_256_prot2.pkl')['preprocessed']
...
print('oi2')
store = Store('all_images_256_256_prot2.2.h5df', mode="w")
...
h5f = h5py.File('./all_images_256_256_prot2.2.h5', 'w')
