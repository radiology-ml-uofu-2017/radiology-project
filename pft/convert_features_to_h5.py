#!/home/sci/ricbl/Documents/virtualenvs/dgx_python3_3/bin/python
...
print('oi1')
listImage = pd.read_pickle('./all_images_224_224_prot2.pkl')['preprocessed']
nimages = listImage.shape[0]
a = np.empty([nimages, 3, 224, 224])
...
print('oi2')
store = Store('all_images_224_224_prot2.2.h5df', mode="w")
...
h5f = h5py.File('./all_images_224_224_prot2.2.h5', 'w')
